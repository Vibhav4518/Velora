...
class Command(BaseCommand):
    help = 'Seeds initial system roles, permissions, base accounts (Super Admin, Store Staff, Customer), coupons, and default shipping address.'

    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.SUCCESS('Starting VELORA System Base Roles & Users Seed...'))
        ...
        if created:
            ...
            admin_user.save()
            self.stdout.write(self.style.SUCCESS('  + Created Super Admin: admin@velora.com'))
        else:
            self.stdout.write(self.style.WARNING('  = Super Admin already exists: admin@velora.com'))
        ...
        if created:
            ...
            staff_user.save()
            self.stdout.write(self.style.SUCCESS('  + Created Store Staff: staff@velora.com'))
        else:
            self.stdout.write(self.style.WARNING('  = Store Staff already exists: staff@velora.com'))
        ...
        if created:
            ...
            customer_user.save()
            self.stdout.write(self.style.SUCCESS('  + Created Customer: customer@velora.com'))
        else:
            self.stdout.write(self.style.WARNING('  = Customer already exists: customer@velora.com'))
        ...
        self.stdout.write(self.style.SUCCESS('VELORA Seeding Complete! Only base roles and user accounts were seeded.'))
